...
本文件列出 Flourish 的所有功能需求，按功能領域組織並按實作 Release 排定優先級。

**優先級**:

- **P0 (Must Have)**：MVP 核心功能 (Release 1)
- **P1 (Should Have)**：Release 2 重要功能
- **P2 (Nice to Have)**：未來增強功能 (Release 3+)
